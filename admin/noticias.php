 ...
 <body>
     <div class="container-fluid">
         ...
         <?php
            ...
            ?>
         <a href="noticias_nuevas.php" class="btn btn-outline-primary">Nueva Noticia</a>
     </div>
     <table class="table">
         <tr>
             <th>titulo</th>
         ...
         <?php
            ...
            //trabajar con super usuario y discriminacion de usuario
            // if(isset($_SESSION['SUPER']))
            //     $instruccion = "select * from noticias order by fecha desc";
            //     else
            //     $instruccion = "select * from noticias where id_usuario=".$_SESSION['id_usuario']
